...
include "session.php";
	...
	try 
	{
		$sql= "SELECT PostID, PosterID, poster_user, PosterName, PostImage, PostTitle, PostContent, PostDate from posts_news ORDER by PostID desc LIMIT 3";
...
<div id="container">
	...
	<section id="left">
		...
		{
	?>
	<button class="clickforpost" title="Publish a new article" onClick="MM_openBrWindow('post_news.php','information','status=yes,scrollbars=no,resizable=no,width=1920,height=1080')">Publish a new article</button>
	<?php
		}
	?>
	...
	{
		$postcontent=substr($postcontent,0,300)."... <br><a class='readmore' href='view_post.php?postid=" . $post['PostID'] . "' target='_blank'>Read More</a>"; 
	}?>
	
	 <p><?php echo "<table width=\"500\"><tr><td>" . "</td></tr><tr><td>" . "<a class='posttitle' href='view_post.php?postid=" . $post['PostID'] . "' target='_blank'>" . $post['title'] . "</a>" . "</td></tr><tr><td>" . "<h3>"
				 . $post['name'] . "&nbsp" . "&#10072; " . $post['date'] . "</h3>" . "</td></tr><tr><td>" . "<img width='1280' height='720' src='".$post['img']."'/>" 
				 . "</td></tr>"; 
				 
				 echo "<tr><td class='content'>" . $postcontent . "</td></tr><tr><td>"; 
				 ...
				 {
					echo "<a class='delete' title='delete this post' onClick=\"MM_openBrWindow('delete.php?postid=" . $post['PostID'] . "','information','status=yes,scrollbars=no,resizable=no,width=450,height=95')\"\>Delete</a></td></tr></table>";
				 }		
	?></p>
	<?php
	 endforeach; ?>
...
<div id="twitterfeed">
<a class="twitter-timeline" href="https://twitter.com/liamc_1996/lists/tech-news" data-widget-id="702120180403585024">Tweets from https://twitter.com/liamc_1996/lists/tech-news</a>
